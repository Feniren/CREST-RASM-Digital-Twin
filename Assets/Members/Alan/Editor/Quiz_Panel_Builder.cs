...
// This is a status/results readout only — the actual quiz interaction
// happens on the same 3D markers/panel actions SequenceManager already
// teaches with, not on this canvas. After building, reposition/rotate it in
// -editor to face the play space, set Quiz_Manager's Max Allowed Errors, then
// save the scene.
public static class Quiz_Panel_Builder
{
    ...
    public static void BuildPanel()
    {
        ...
        // Quiz panel starts hidden — Quiz_Manager.Awake() deactivates
        // quizPanel/resultsPanel, and BeginQuiz() (called automatically by
        // SequenceManager once its walkthrough finishes, via the field just
        // wired below) is what turns it on.
        ...
        Debug.Log("Quiz_Panel_Builder: panel built and wired to the scene's SequenceManager. Reposition/rotate it to face the play space, then save the scene.");
    }
