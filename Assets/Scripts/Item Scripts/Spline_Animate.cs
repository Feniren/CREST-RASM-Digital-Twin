...
using UnityEditor;
    ...
    /// </summary>
    [AddComponentMenu("Splines/Animate")]
    [HelpURL(k_HelpUrl)]
    [ExecuteInEditMode]
    public class Spline_Animate : SplineComponent{
        const string k_HelpUrl = "https://docs.unity3d.com/Packages/com.unity.splines@latest/index.html?subfolder=/manual/animate-component.html";
